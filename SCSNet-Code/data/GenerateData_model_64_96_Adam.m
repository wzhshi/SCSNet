...
folder_train  = 'E:\BSDS500\data\images\train';  %%% training
folder_test   = 'E:\datasets\BSDS500\data\images\val';%%% testing
size_input    = 96;          %%% training
size_label    = 96;          %%% testing
stride_train  = 100;          %%% training
stride_test   = 180;          %%% testing
